...
map: textureLoader.load('static/photos/pano1.jpg'),
alphaMap: textureLoader.load('static/photos/pano1alpha.jpg'),
...
gltfLoader.load(`static/model/${model}.glb`, function(glb){
    ...
    extension.position.x= 7.8; 
    extension.position.y= 4.04; 
    extension.position.z= 5.7;
