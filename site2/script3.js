...
// Canvas
var canvas = document.getElementById('streetview3')
...
map: textureLoader.load('static/photos/pano3.jpg'),
alphaMap: textureLoader.load('static/photos/pano3alpha.jpg'),
...
gltfLoader.load(`static/model/${model}.glb`, function(glb){
    ...
    extension.position.x= -4.1; 
    extension.position.y= -0.043; 
    extension.position.z= 3.42;
    extension.scale.set(1,1.5,1); 

    extension.rotation.y= -19.1;
...
document.getElementById("shot1.3").addEventListener('click', takeScreenshot);
