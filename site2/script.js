...
map: textureLoader.load('static/photos/pano.jpg'),
alphaMap: textureLoader.load('static/photos/panoalpha.jpg'),
...
gltfLoader.load(`static/model/${model}.glb`, function(glb){
    ...
    extension.position.x= -2.5; 
    extension.position.y= 0.24; 
    extension.position.z= 4.01;
    extension.scale.set(0.8,1.5,0.9); 

    extension.rotation.y= -44;
