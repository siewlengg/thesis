...
map: textureLoader.load('static/photos/panoflip.jpg'),
alphaMap: textureLoader.load('static/photos/alphamap1_flip.jpg'),
...
//gltf 
var modelList = ['model1','model2','model3','model4','model5', 'model6']

/*
let i= 0; 

function prevModel(){
    // change gltf model number to -1 
    i = (i-1) % modelList.length
}
...
gltfLoader.load('static/model/`${modellist[i]}.glb`', function(glb){
    console.log(glb);
    const extension = glb.scene;
    extension.position.x= -5.5; 
    extension.position.y= 3; 
    extension.position.z= -3.8;
    extension.scale.multiplyScalar(2); 

    extension.rotation.y= 0.5;
...
gltfLoader.load(`static/model/${model}.glb`, function(glb){
    console.log(glb);
    const extension = glb.scene;
    extension.position.x= -5.3; 
    extension.position.y= 3; 
    extension.position.z= -3.9;
    extension.scale.multiplyScalar(2); 
